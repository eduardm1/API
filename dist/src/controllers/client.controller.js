...
let ClientController = class ClientController extends tsoa_1.Controller {
    getClients(offset, limit, clientCode) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield client_repository_1.getClients(offset, limit, clientCode);
        });
    }
    createClient(body) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield client_repository_1.createClient(body);
        });
    }
    updateClient(body) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield client_repository_1.updateClient(body);
        });
    }
    deleteClient(clientCode) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield client_repository_1.deleteClient(clientCode);
        });
    }
};
__decorate([
    tsoa_1.Get("/:clientCode?"),
